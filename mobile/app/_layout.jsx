...
import { startSyncListener, stopSyncListener, startRealtimeSync, stopRealtimeSync, fetchVotersForBooth, fetchActiveSurveyData, fetchActivePoll } from '../src/services/sync'
...
function AuthGuard() {
  ...
  useEffect(() => {
    if (isAuthenticated) {
      startSyncListener()
      const { agent, setVoters, setActiveSurvey, setActivePhase, setActivePoll, loadPending, loadPendingPolls } = useStore.getState()
      loadPending()
      loadPendingPolls()
      if (agent?.boothNo) {
